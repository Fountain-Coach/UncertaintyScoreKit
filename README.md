...
**Status:** 0.11.0 — shared note visual identity, reciprocal host selection, semantic selection swell, and pointer activation. The model, SwiftUI renderer, snapshot
